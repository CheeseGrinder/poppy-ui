...
import { AutoCapitalize, Color, EnterKeyHint, Size } from "./interface.d";
import { ButtonColor, ButtonExpand, ButtonShape } from "./components/button/button.type";
import { CheckboxPlacement } from "./components/checkbox/checkbox.type";
...
import { InputColor } from "./components/input/input.type";
import { InputFileColor } from "./components/input-file/input-file.type";
