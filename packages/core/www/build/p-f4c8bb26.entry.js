...
var u = undefined && undefined.__classPrivateFieldGet || function(o, r, t, e) {
...
const p = class {
  ...
  componentWillLoad() {
    a.apply(this, "pop-button", {
      disabled: false,
      size: c.get("defaultSize", "md"),
      outlined: false
    });
  }
  componentWillRender() {
    h(this, b, s(this.host), "f");
  }
  render() {
    const {host: o, disabled: r} = this;
    return t(e, {
      key: "57510607361e45f03e3659421036156775ef50ca",
      "aria-disabled": r ? "true" : null,
      class: {
        "join-item": i(o, "pop-join")
      }
    }, t("button", {
      key: "304e988b72597785eb1d912b7d367b3d4916d86c",
      part: "native",
      disabled: r,
      onFocus: u(this, k, "f"),
      onBlur: u(this, v, "f"),
      ...
      key: "b926b5b106c068ec308b37bfbd085c19c3c10c04",
      name: "start-icon"
    }), t("slot", {
      key: "5d5ebdf5f005480518b0c4fb80afd4fa35939c32"
    }), t("slot", {
      key: "0d4c925afa8244d7b9e7fd8a09095d4c097de4f3",
      name: "end-icon"
    })));
  }
  get host() {
...
b = new WeakMap, k = new WeakMap, v = new WeakMap;

p.style = l;

export { p as pop_button };
//# sourceMappingURL=p-f4c8bb26.entry.js.map