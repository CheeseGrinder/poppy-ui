 ...
 */
import { AutoCapitalize, Autocomplete, Color, ComponentProps, ComponentRef, EnterKeyHint, InputType, KeyboardType, Placement, Size, StateColor, Wrap } from "./interfaces.d";
...
export interface ComponentOptions {
  ...
  "pop-badge"?: {
     ...
     * For more information on colors, see [theming](/docs/theming/basics).
     */
    color?: "accent" | "error" | "info" | "neutral" | "primary" | "secondary" | "success" | "warning";
    /**
     *
  ...
  "pop-button"?: {
     ...
     * For more information on colors, see [theming](/docs/theming/basics).
     */
    color?: "accent" | "error" | "ghost" | "info" | "neutral" | "primary" | "secondary" | "success" | "warning";
    /**
     *
     * Change size of the component
     * Options are: `"xs"`, `"sm"`, `"md"`, `"lg"`.
  ...
  "pop-divider"?: {
     ...
     */
    placement?: "center" | "end" | "left" | "right" | "start";
    /**
     *
     * The color to use from your application's color palette.
  ...
  "pop-indicator"?: {
     ...
     */
    side?: "center" | "end" | "left" | "right" | "start";
    /**
     *
  ...
  "pop-radio-group"?: {
     ...
     */
    compare?: ((currentValue: any, newValue: any) => boolean) | string;
    /**
     *
     * The color to use from your application's color palette.
     * Default options are: `"primary"`, `"secondary"`, `"accent"`, `"info"`, `"success"`, `"warning"`, `"error"`.
