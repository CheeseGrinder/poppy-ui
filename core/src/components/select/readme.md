...
| `placeholder`        | `placeholder`           | Instructional text that shows before the input has a value.<br>This property replace the `<option disabled selected>`                                                                                                                                     | `string`                                                                                         | `undefined`   |
