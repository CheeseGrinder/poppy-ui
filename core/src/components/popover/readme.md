...
| `componentProps`  | `undefined`        | The data to pass to the popover component.<br>You only need to use this if you are not using<br>a JavaScript framework. Otherwise, you can just<br>set the props directly on your component.                                                                                                                                                                                                                                                                                                                                                      | `{ [key: string]: any; }`              | `undefined` |
| `event`           | `undefined`        | The event to pass to the popover animation.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | `Event`                                | `undefined` |
