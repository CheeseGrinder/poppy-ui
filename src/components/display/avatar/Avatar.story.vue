...
| `placeholder` | `Booleanish`    | `false`         | :x:      | :x:                | Adds `avatar-placeholder`. Use with text initials instead of an image.                                     |
| `group`       | `Booleanish`    | `false`         | :x:      | :x:                | Renders as `avatar-group` to stack multiple avatars with overlap.                                          |
